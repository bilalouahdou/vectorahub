                ...
                <div class="job-card">
                    ...
                    ${
                      job.status === "done" && job.output_svg_path
                        ...
                        <div class="text-center mb-3">
                            <object type="image/svg+xml" data="download.php?file=${encodeURIComponent(job.output_svg_path)}" class="svg-preview" style="max-width: 100px; max-height: 100px;"></object>
                        </div>
                    `
                        : ""
                    }
                    ...
                    <div class="d-flex gap-2">
                        ${
                          job.status === "done" && job.output_svg_path
                            ? `
                            <a href="download.php?file=${encodeURIComponent(job.output_svg_path)}" class="btn btn-accent btn-sm flex-grow-1" download>
                                ⬇️ Download
                            </a>
                        `
                            : job.status === "failed"
